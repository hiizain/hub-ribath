    ...
    <div class="wrapper toggled" id="wrapper">
        <div class="sidebar-wrapper" id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav ps-0 my-2">
                ...
                <li class="sidebar-brand">
                    <a class="d-flex align-items-center collapsed" id="dropdown-menu" data-bs-toggle="collapse" data-bs-target="#layanan-collapse" aria-expanded="false">
                        <i class="fa-solid fa-house"></i>
                        <p class="ms-2 my-0 p-0">Layanan</p>
                    </a>
                    <div class="collapse p-0" id="layanan-collapse" style="">
                        <ul class="sidebar-nav-dropdown fw-normal small">
                            <li><a href="{{ route('back.layanan.sewa') }}" class="d-flex nav-link">Sewa Medai</a></li>
                            <li><a href="{{ route('back.layanan.safari') }}" class="d-flex nav-link">Safari Maulid</a></li>
                        </ul>
                    </div>
                </li>
                <li class="sidebar-brand">
                    <a class="d-flex align-items-center collapsed" id="dropdown-menu" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
                        <i class="fa-solid fa-house"></i>
                        <p class="ms-2 my-0 p-0">Home</p>
                    </a>
                    <div class="collapse p-0" id="home-collapse" style="">
                        <ul class="sidebar-nav-dropdown fw-normal small">
                            <li><a href="2" class="d-flex nav-link">Overview</a></li>
                            <li><a href="3" class="d-flex nav-link">Updates</a></li>
                            <li><a href="4" class="d-flex nav-link">Reports</a></li>
                        </ul>
                    </div>
                </li>
                <hr>
